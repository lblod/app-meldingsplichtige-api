...
export const DL_READY = "http://lblod.data.gift/file-download-statuses/ready-to-be-cached";
export const DL_ONGOING = "http://lblod.data.gift/file-download-statuses/ongoing";
